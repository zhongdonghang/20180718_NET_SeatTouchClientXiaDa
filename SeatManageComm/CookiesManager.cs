...
namespace SeatManage.SeatManageComm
{
    public class CookiesManager
    {
        ...
        public static void SetCookies(string loginId, string passWord, string connectionString, string schoolId)
        {
            try
            {
